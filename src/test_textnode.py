...
class TestTextNode(unittest.TestCase):
    ...
    def test_repr(self):
        node = TextNode(
            "This is a text node", TextType.LINK_TEXT, "http://link_nodes.com"
        )
        self.assertEqual(
...
class TestTextToHTML(unittest.TestCase):
    ...
    def test_link_text(self):
        node = TextNode(
            ...
            TextType.LINK_TEXT,
            "https://gotfandom/housemartel.com",
        )
        html_node = text_node_to_html_node(node)
    ...
    def test_img(self):
        node = TextNode(
            "golden rose on a green background",
            TextType.IMAGE_TEXT,
            "https://gotfandom/housetyrell/images/sigil.jpg",
        )
        html_node = text_node_to_html_node(node)
        ...
        self.assertEqual(
            html_node.props,
            {
                "src": "https://gotfandom/housetyrell/images/sigil.jpg",
                "alt": "golden rose on a green background",
            },
        )
